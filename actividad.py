...
def remove_songs():
    ...
    while True:
        ...
        else: print("Song does not exist!")
        pass
...
def find_common_songs():
    ...
    # YOUR CODE HERE:
    common = friend_songs.intersection(my_playlist)
    # Display results
    if common:
...
def mark_favorites():
    ...
    while True:
        ...
        if song in my_playlist:
             favorites.add(song)
        else: print("Song must be in your playlist!")
        pass
